...
正式下载：[StereoRange v1.0.2+23](https://github.com/mcxiaochenn/StereoRange/releases/tag/v1.0.2%2B23)（`arm64-v8a`，公开包仅内置官方识别模型，真实测距前需导入自己的标定文件）。应用设置页可一键打开 GitHub 仓库。3D 打印模型位于 [assets/3d-print](assets/3d-print/)，论文草稿位于 [assets/papers](assets/papers/)。
